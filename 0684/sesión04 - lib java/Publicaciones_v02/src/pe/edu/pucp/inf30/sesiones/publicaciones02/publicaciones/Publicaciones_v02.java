...
import pe.edu.pucp.inf30.sesiones.publicaciones02.publicaciones.estandardIEEE.Tesis;
import pe.edu.pucp.inf30.sesiones.publicaciones02.publicaciones.estandardIEEE.Libro;
import pe.edu.pucp.inf30.sesiones.publicaciones02.publicaciones.estandardIEEE.Articulo;

public class Publicaciones_v02 {

    public static void main(String[] args) {
        Publicacion publicaciones[] = new Publicacion[3];
        //esta solución no es elegante
        //if (imprimirEnAPA)
