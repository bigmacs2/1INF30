...
namespace Publicaciones_v01
{
    public class Principal
    {
        static void Main(string[] args)
        {
            ...
            publicaciones[1] = new EstandardIEEE.Libro("Design Patterns: Elements of Reusable Object-Oriented Software", autores, 1970, "1er edición", "Massachusetts", "Addison-Wesley Professional");
